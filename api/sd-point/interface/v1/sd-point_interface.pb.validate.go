...
// Validate checks the field values on LoginRequest_WechatAccount with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *LoginRequest_WechatAccount) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LoginRequest_WechatAccount with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// LoginRequest_WechatAccountMultiError, or nil if none found.
func (m *LoginRequest_WechatAccount) ValidateAll() error {
	return m.validate(true)
}

func (m *LoginRequest_WechatAccount) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetOpenIdCode()) != 32 {
		err := LoginRequest_WechatAccountValidationError{
			field:  "OpenIdCode",
	...
	if len(errors) > 0 {
		return LoginRequest_WechatAccountMultiError(errors)
	}

	return nil
}

// LoginRequest_WechatAccountMultiError is an error wrapping multiple
// validation errors returned by LoginRequest_WechatAccount.ValidateAll() if
// the designated constraints aren't met.
type LoginRequest_WechatAccountMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LoginRequest_WechatAccountMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LoginRequest_WechatAccountMultiError) AllErrors() []error { return m }

// LoginRequest_WechatAccountValidationError is the validation error returned
// by LoginRequest_WechatAccount.Validate if the designated constraints aren't met.
type LoginRequest_WechatAccountValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LoginRequest_WechatAccountValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LoginRequest_WechatAccountValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LoginRequest_WechatAccountValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LoginRequest_WechatAccountValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LoginRequest_WechatAccountValidationError) ErrorName() string {
	return "LoginRequest_WechatAccountValidationError"
}

// Error satisfies the builtin error interface
func (e LoginRequest_WechatAccountValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLoginRequest_WechatAccount.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LoginRequest_WechatAccountValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LoginRequest_WechatAccountValidationError{}
