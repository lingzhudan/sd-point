...
func (m *CreatePointRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetName()); l < 1 || l > 32 {
		err := CreatePointRequestValidationError{
			field:  "Name",
...
func (m *ListPointRequest) validate(all bool) error {
	...
	if m.GetCount() >= 32 {
		err := ListPointRequestValidationError{
			field:  "Count",
...
// Validate checks the field values on GetRecordReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *GetRecordReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetRecordReply with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in GetRecordReplyMultiError,
// or nil if none found.
func (m *GetRecordReply) ValidateAll() error {
	return m.validate(true)
}

func (m *GetRecordReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetRecordReplyValidationError{
					field:  "Record",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetRecordReplyValidationError{
				field:  "Record",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetRecordReplyMultiError(errors)
	}

	return nil
}

// GetRecordReplyMultiError is an error wrapping multiple validation errors
// returned by GetRecordReply.ValidateAll() if the designated constraints
// aren't met.
type GetRecordReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetRecordReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetRecordReplyMultiError) AllErrors() []error { return m }

// GetRecordReplyValidationError is the validation error returned by
// GetRecordReply.Validate if the designated constraints aren't met.
type GetRecordReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetRecordReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetRecordReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetRecordReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetRecordReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetRecordReplyValidationError) ErrorName() string { return "GetRecordReplyValidationError" }

// Error satisfies the builtin error interface
func (e GetRecordReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = GetRecordReplyValidationError{}
